...
var knife,fruit ,monster,fruitGroup,monsterGroup, score,r,randomFruit, position,back,backs;
...
function preload(){
  ...
  knifeImage = loadImage("k2.png");
  monsterImage = loadImage("b2.png")
  ...
  //load sound here
knifes = loadSound("s mp3.mp3")
game = loadSound("over.mp3")
}
...
function setup() {
  ...
  backs = createSprite(300,300,20,20)
  backs.addImage(back)
